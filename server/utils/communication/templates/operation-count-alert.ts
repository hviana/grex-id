...
export async function operationCountAlertTemplate(
  locale: string,
  data: {
    name: string;
    systemName: string;
  ...
  const content = `
    ...
    <tr>
      <td style="padding: 16px 0 8px 0; font-size: 22px; font-weight: 700; color: #ffffff; text-align: center; letter-spacing: -0.3px;">
        ${t("templates.operationCountAlert.title", locale)}
      </td>
    </tr>
    ...
    <tr>
      <td style="padding: 0 0 24px 0; font-size: 15px; line-height: 1.6; color: #cccccc; text-align: center;">
        ${
    t("templates.operationCountAlert.greeting", locale, { name: data.name })
  }
      </td>
    </tr>
    ...
    <!-- Info card: system + operation count -->
    <tr>
      <td style="padding: 0 0 24px 0;">
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                      <tr>
                        <td style="font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 1px; color: #888888; padding: 0 0 4px 0;">
                          ${
    t("templates.operationCountAlert.systemLabel", locale)
  }
                        </td>
                      </tr>
                      <tr>
                  ...
                  <td style="padding: 12px 0 0 0;">
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                      <tr>
                        <td style="font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 1px; color: #888888; padding: 0 0 4px 0;">
                          ${
    t("templates.operationCountAlert.countLabel", locale)
  }
                        </td>
                      </tr>
                      <tr>
    ...
    <tr>
      <td style="padding: 0 0 32px 0; font-size: 14px; line-height: 1.7; color: #aaaaaa; text-align: center;">
        ${t("templates.operationCountAlert.body", locale)}
      </td>
    </tr>
    ...
    t("templates.operationCountAlert.action", locale)
  }</span>
          ...
          <tr>
            <td style="padding: 14px 24px; background-color: rgba(2, 208, 125, 0.06); border: 1px solid rgba(2, 208, 125, 0.15); border-radius: 10px;">
              <span style="font-size: 13px; line-height: 1.5; color: #02d07d;">
                &#x1F504; ${
    t("templates.operationCountAlert.renewalNote", locale)
  }
              </span>
            </td>
          </tr>
  ...
  return {
    title: t("templates.operationCountAlert.subject", locale, {
      systemName: data.systemName,
    }),
    body: await emailLayout(
      content,
      locale,
      t("templates.operationCountAlert.preheader", locale),
    ),
  };
}
