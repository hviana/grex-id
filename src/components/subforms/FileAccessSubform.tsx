  ...
  useImperativeHandle(ref, () => ({
    getData: () => {
      ...
      const downloadSection: FileAccessSection = {
        ...
        roles: Array.isArray(dlTenant.roleIds)
          ? dlTenant.roleIds
          : download.roles,
      };
      ...
      const uploadSection: FileAccessUploadSection = {
        ...
        roles: Array.isArray(ulTenant.roleIds)
          ? ulTenant.roleIds
          : upload.roles,
