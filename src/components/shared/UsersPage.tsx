...
import InviteUserModal from "@/src/components/shared/InviteUserModal";
        ...
        {isAdmin && (
          <div className="flex items-center gap-2">
            <button
              ...
              className="rounded-lg border border-dashed border-[var(--color-dark-gray)] bg-white/5 backdrop-blur-md px-4 py-2 text-sm font-medium text-[var(--color-light-text)] hover:-translate-y-0.5 hover:border-[var(--color-primary-green)]/40 hover:text-white hover:shadow-lg hover:shadow-[var(--color-light-green)]/10 transition-all"
            >
              {t("common.users.invite")}
            </button>
            <CreateButton
              onClick={() => {
                setCreateOpen(true);
          ...
          <div className="space-y-3">
            ...
            <UserSubform
              ...
              initialData={{
                ...
                contextRoles: editUser._resourceLimitRoleNames ??
                  editUser.contextRoles ?? [],
