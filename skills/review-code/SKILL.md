...
Do NOT use this skill for a scoped review of a single file, a single subsystem,
or a single framework — use the normal review flow and the `isolation-guard`
skill to confirm the target layer.
