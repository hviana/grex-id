...
# Query from a file
tsx skills/test-db-queries/run.ts -f /tmp/debug.surql

# Query from a file plus bindings from a JSON file
tsx skills/test-db-queries/run.ts -f /tmp/debug.surql --bindings-file /tmp/vars.json

# Query via stdin (handy for heredocs)
tsx skills/test-db-queries/run.ts --stdin <<'SURQL'
