...
4. **If a fix is ambiguous or has trade-offs, present options to the user before
   proceeding.**
5. **After every phase, run the dev server and smoke-test affected flows.**
6. **Create a commit after each phase** with a descriptive message following the
   pattern: `review: phase N — <description>`.
